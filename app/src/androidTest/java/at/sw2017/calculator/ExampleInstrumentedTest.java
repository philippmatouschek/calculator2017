...
public class ExampleInstrumentedTest {
    ...
    public void testCalcClass(){
        ...
        int result = calc.doAddition(13, 5);
        assertEquals(18, result);
    }

    @Test
    public void testStates(){
        MainActivity.State teststate;
        teststate = MainActivity.State.ADD;
        assertEquals(MainActivity.State.ADD, teststate.ADD);
    }
